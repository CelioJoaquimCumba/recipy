...
export const NavBar = () => {
    ...
    return(
        <div className={`flex flex-row bg-gray-50 rounded-b-2xl  w-full px-2 py-4 justify-between items-end sticky top-0 z-10 transition-transform duration-500 ${scrollingUp ? 'translate-y-0' : '-translate-y-full'}`}>
