    ...
    return (
        <div className="flex flex-col items-start w-screen h-full p-4 pt-2 bg-gray-100">
            ...
            <div className="flex py-4 flex-col gap-4 flex-grow self-stretch">
                <img className=" h-64 w-full object-cover rounded-md self-stretch" src="https://images.pexels.com/photos/3220617/pexels-photo-3220617.jpeg?auto=compress&cs=tinysrgb&w=1600" alt="food image" />
                {/* rating and categories */}
                <div className="flex justify-between items-center self-stretch">
                    <Pill  active={true} category={"Breakfast"} onClick={() => {} }/>
                    {/* rating */}
